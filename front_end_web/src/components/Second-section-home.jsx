    ...
    return (
        ...
        <div className="section2">
            ...
            <div className="section2-first-img">
                <h2>
                    {" "}
                    BuildBeyond <span> Hightech </span>{" "}
                </h2>
            </div>
            ...
            <div className="about-company-section">
                <div className="container">
                    <div className="about-text">
                        ...
                        <h2>
                            {" "}
                            Providing your business with a quality IT service is
                            our passion.{" "}
                        </h2>
                        <p>
                            {" "}
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Culpa reiciendis ipsum dolor facilis iusto ab
                            voluptate amet architecto commodi, quibusdam
                            quisquam, accusamus quas veniam officiis deserunt!
                            Odit culpa optio impedit!{" "}
                        </p>
            ...
            <div className="chooseUs-section">
                <div className="chooseUs-container">
                    ...
                    <div className="chooseUs-text">
                        ...
                        <h2>
                            {" "}
                            Safeguard your brand withCyber- Security & IT
                            Solutions
                        </h2>
                        <p>
                            {" "}
            ...
            <div className="get-started">
                <div className="container-GS">
                    <img
                        className="bbh-logo"
                        src={require("../images/BBH black and yellow.png")}
                        alt=""
                    />
                    <div className="text">
                        ...
                        <p>
                            {" "}
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Qui veniam laudantium ipsam officia obcaecati
                            temporibus officiis eligendi inventore soluta ullam
                            tempore provident quis, similique eaque in quae
                            ducimus minus quos!
                        </p>
